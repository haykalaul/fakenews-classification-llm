...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://github.com/haykalaul/fakenews-classification-llm",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/haykalaul_/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/haykalaulilalbab/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Hugging Face",
    href: "https://huggingface.co/skyzen122",
    icon: (
...
className="h-8 w-auto ml-[-12px]" // geser kiri sejauh 12px
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
            <p>&copy; {currentYear} Realnih. Semua hak cipta dilindungi.</p>
